...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    values.picturePath = dataFromCloudinary.secure_url;
    ...
    const saveUserResponse = await fetch(
      // wait api
      'https://travel-api-nu.vercel.app/users/createUser',
      {
        method: 'POST',
  ...
  const login = async (values, onSubmitProps) => {
    const loggedInResponse = await fetch(
      // wait api
      'https://travel-api-nu.vercel.app/auth/login',
      {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <Formik
      ...
      valiadationSchema={isLogin ? loginSchema : registerSchema}
    >
      {({
        values,
        errors,
